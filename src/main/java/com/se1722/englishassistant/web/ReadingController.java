...
//        循环比较答案
    ...
    public RestResponse insertHistory(@RequestBody ReadingListEntity readingListEntity) {
        Date time = new Date();
     ...
     */
    private void getWholeGroupInformation(List<ReadingGroupEntity> readingGroupEntities, List<RestReadingGroupEntity> restReadingGroupEntities) {
